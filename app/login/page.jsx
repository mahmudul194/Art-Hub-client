  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center pt-32 pb-12 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-zinc-950 relative overflow-x-hidden">
      ...
      <motion.div 
        ...
        className="max-w-md w-full my-auto space-y-8 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl p-10 rounded-3xl shadow-2xl z-10 border border-slate-200 dark:border-zinc-800"
      >
        <div>
